...
node.force_default[:rbenv][:root]          = rbenv_root_path
node.force_default[:ruby_build][:prefix]   = "#{node[:rbenv][:root]}/plugins/ruby_build"
node.force_default[:ruby_build][:bin_path] = "#{node[:ruby_build][:prefix]}/bin"
