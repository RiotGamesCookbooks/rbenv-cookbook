...
node.override[:rbenv][:root]          = rbenv_root_path
node.override[:ruby_build][:prefix]   = "#{node[:rbenv][:root]}/plugins/ruby_build"
node.override[:ruby_build][:bin_path] = "#{node[:ruby_build][:prefix]}/bin"
